...
defmodule Ash.Reactor.StepUtils do
  ...
  @doc false
  @spec store_changeset_in_metadata(atom, Ash.Resource.Record.t(), Ash.Changeset.t()) ::
  ...
  @doc false
  @spec get_changeset_from_metadata(atom, Ash.Resource.Record.t()) :: Ash.Changeset.t()
