...
defmodule Ash.Reactor.BulkDestroyStep do
  @moduledoc """
  The Reactor step which is used to execute destroy actions in bulk.
  """
  ...
  def run(arguments, context, options) do
    ...
    arguments.initial
    |> Ash.bulk_destroy(options[:action], arguments[:input], bulk_destroy_options)
    |> case do
