...
defmodule Ash.SatSolver.Formula do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> import Ash.SatSolver.Expression
      iex> expression = b(:a and :b)
      iex> Formula.from_expression(expression)
      %Formula{
        cnf: [[1], [2]],
        bindings: %{1 => :a, 2 => :b},
  ...
  ## Examples
      ...
      iex> alias Ash.SatSolver.{Expression, Formula}
      iex> formula = Formula.from_expression(Expression.b(:a and :b))
      iex> Formula.to_picosat(formula)
      "p cnf 2 2\\n1 0\\n2 0"
  ...
  defp bind_variable(boolean, _bindings) when is_boolean(boolean) do
    raise Ash.Error.Framework.AssumptionFailed,
      message: """
      All booleans in expression should have been expanded.\
      """
  end

  defp bind_variable(expr, bindings) do
    {expr, bindings}
  end
