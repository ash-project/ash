...
defmodule Ash.SatSolver.Expression.RewriteRule do
  @moduledoc false
  ...
  ## Examples
      ...
      iex> alias Ash.SatSolver.Expression.RewriteRule.NegationLaw
      iex> expr = b(not not :a)
      iex> {result, _acc_map} = RewriteRule.apply(expr, [NegationLaw])
      iex> result
      :a
  ...
  defp initialize_accumulator_map(rules) do
    rules
    |> Enum.reduce(%{}, fn rule_spec, acc_map ->
