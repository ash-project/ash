defmodule Ash.Test.Type.DecimalTest do
  ...
  test "allow arbitrary precision when set to :arbitrary" do
    valid_attrs = @valid_attrs |> Map.put(:arbitrary_amount, Decimal.new("12345678901234567890.123456789"))
  ...
  test "allow arbitrary scale when set to :arbitrary" do
    valid_attrs = @valid_attrs |> Map.put(:arbitrary_scale_amount, Decimal.new("123.123456789012345"))
  ...
  test "scale constraint defaults to :arbitrary" do
    ...
    assert {:ok, _} = Ash.Type.Decimal.cast_input("123.123456789012345678901234567890", constraints)
  end
