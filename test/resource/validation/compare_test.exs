defmodule Ash.Test.Resource.Validation.CompareTest do
  ...
  describe "is_equal validation" do
    ...
    test "validates equality with complex data types" do
      ...
      assert_validation_error(create_changeset(%{list_value: [4, 5, 6]}), opts, "must be equal to [1, 2, 3]")
      ...
      assert_validation_error(create_changeset(%{map_value: %{a: 3, b: 4}}), opts, "must be equal to %{a: 1, b: 2}")

      {:ok, opts} = Compare.init(attribute: :tuple_value, is_equal: {1, 2})
      assert_validation_success(create_changeset(%{tuple_value: {1, 2}}), opts)
      assert_validation_error(create_changeset(%{tuple_value: {3, 4}}), opts, "must be equal to {1, 2}")
    end
    ...
    test "validates equality with special types" do
      ...
      assert_validation_error(create_changeset(%{string_value: "world"}), opts, "must be equal to hello")
      ...
      assert_validation_error(create_changeset(%{boolean_value: false}), opts, "must be equal to true")
    end
  end
  ...
  describe "is_not_equal validation" do
    ...
    test "validates inequality with complex data types" do
      ...
      assert_validation_error(create_changeset(%{list_value: [1, 2, 3]}), opts, "must not be equal to [1, 2, 3]")
      ...
      assert_validation_error(create_changeset(%{map_value: %{a: 1, b: 2}}), opts, "must not be equal to %{a: 1, b: 2}")
      ...
      assert_validation_error(create_changeset(%{tuple_value: {1, 2}}), opts, "must not be equal to {1, 2}")
    end
    ...
    test "validates inequality with special types" do
      ...
      assert_validation_error(create_changeset(%{atom_value: :foo}), opts, "must not be equal to foo")
      ...
      assert_validation_error(create_changeset(%{string_value: "hello"}), opts, "must not be equal to hello")
      ...
      assert_validation_error(create_changeset(%{boolean_value: true}), opts, "must not be equal to true")
    end
  end
  ...
  describe "comparison validations" do
    test "validates greater_than" do
      ...
      assert_validation_error(create_changeset_with_arg(:foo, 100, %{number_one: 1}), opts, "must be greater than foo")
      ...
      assert_validation_error(create_changeset(%{number_one: 1, number_two: 100}), opts, "must be greater than number_two")
    ...
    test "validates greater_than_or_equal_to with value syntax" do
      ...
      assert_validation_success(create_changeset(%{number_one: 100}), opts)
      assert_validation_error(create_changeset(%{number_one: 5}), opts, "must be greater than or equal to 10")
    end
    ...
    test "validates less_than_or_equal_to with value syntax" do
      ...
      assert_validation_success(create_changeset(%{number_one: 5}), opts)
      assert_validation_success(create_changeset(%{number_one: 10}), opts)
      assert_validation_error(create_changeset(%{number_one: 15}), opts, "must be less than or equal to 10")
    end
  ...
  test "validates against a range of values" do
    ...
    changeset = create_changeset(%{number_one: -1})
    assert_validation_error(changeset, opts, "must be greater than 0 and must be less than or equal to 10")
  ...
  describe "edge cases" do
    test "validates with nested data structures" do
      ...
      assert_validation_error(create_changeset(%{map_value: %{outer: %{inner: 43}}}), opts, "must be equal to %{outer: %{inner: 42}}")
      ...
      assert_validation_error(create_changeset(%{tuple_value: {1, {2, 4}}}), opts, "must be equal to {1, {2, 3}}")
    end
    ...
    test "validates with empty values" do
      ...
      assert_validation_error(create_changeset(%{string_value: "not empty"}), opts, "must be equal to ")

      # Empty list
      {:ok, opts} = Compare.init(attribute: :list_value, is_equal: [])
      assert_validation_success(create_changeset(%{list_value: []}), opts)
      assert_validation_error(create_changeset(%{list_value: [1, 2, 3]}), opts, "must be equal to []")

      # Empty map
      {:ok, opts} = Compare.init(attribute: :map_value, is_equal: %{})
      assert_validation_success(create_changeset(%{map_value: %{}}), opts)
      assert_validation_error(create_changeset(%{map_value: %{a: 1}}), opts, "must be equal to %{}")
    end
    ...
    test "validates with function values" do
      ...
      assert_validation_success(create_changeset(%{number_one: 100}), opts)
      assert_validation_error(create_changeset(%{number_one: 10}), opts, "must be greater than 42")
    end
  end
