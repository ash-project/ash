...
| [`through`](#relationships-has_one-through){: #relationships-has_one-through } | `any` |  | The resource to use as the join resource. |
...
| [`through`](#relationships-has_many-through){: #relationships-has_many-through } | `any` |  | The resource to use as the join resource. |
...
| [`through`](#relationships-belongs_to-through){: #relationships-belongs_to-through } | `any` |  | The resource to use as the join resource. |
